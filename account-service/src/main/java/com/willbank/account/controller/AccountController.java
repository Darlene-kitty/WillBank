...
public class AccountController {
    ...
    public ResponseEntity<Void> creditAccount(@PathVariable Long id, @RequestParam BigDecimal amount) {
    ...
    public ResponseEntity<Void> debitAccount(@PathVariable Long id, @RequestParam BigDecimal amount) {
