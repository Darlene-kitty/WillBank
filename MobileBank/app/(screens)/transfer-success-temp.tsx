...
export default function DepositSuccessScreen() {
  ...
  const { amount, account, method } = useLocalSearchParams();
      ...
      <View style={styles.content}>
        ...
        >
          ...
          <Text style={[styles.successMessage, { color: colors.textSecondary }]}>
            Votre demande de dépôt a été enregistrée avec succès
          </Text>
        </Animated.View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.infoText, { color: colors.textSecondary }]}>
              {depositDetails.method === 'Chèque' 
                ? 'Votre dépôt sera crédité sous 2-3 jours ouvrés'
                : depositDetails.method === 'Virement'
                ? 'Votre dépôt sera crédité sous 1-2 jours ouvrés'
                : 'Votre dépôt sera crédité immédiatement'
              }
            </Text>
          </View>
        </Animated.View>
